...
export async function checkMention(castHash: string, _fid: number, castText: string) {
    ...
    await startGameRegistration(matchedGameId, castHash);
}

export async function startGameRegistration(gameId: number, registrationCastHash: string) {
